 ...
 * so. This is the page that would have failed hardest: the form is a Client Component calling `resetPasswordForEmail` in the browser, so unhydrated it is a dead input above a button that does nothing.
 *
